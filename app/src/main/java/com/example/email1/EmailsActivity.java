...
import com.example.email1.adapter.CostumEmailsAdapter;
import com.example.email1.job_service.NotificationJobService;
import com.example.email1.model.AccountUser;
import com.example.email1.model.Message;
import com.example.email1.model.Tag;
...
public class EmailsActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //na dume pismo prelazimo na createEmailActivity i vucemo object accountUser ceo
        MenuItem menuItem=menu.findItem(R.id.create_email);
        menuItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent=new Intent(EmailsActivity.this,CreateEmailActivity.class);
                //intent.putExtra("username",accountUser);
                startActivity(intent);
                return false;
            }
        });
