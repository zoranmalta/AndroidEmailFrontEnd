package com.example.email1.adapter;
...
public class CostumEmailsAdapter extends ArrayAdapter<Message> implements View.OnClickListener {

    private ArrayList<Message> messages;
    private ArrayList<Message> messagesFull;
    Context mContext;

    public CostumEmailsAdapter(ArrayList<Message> messages,Context context){
...
//        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.txtFrom = (TextView) convertView.findViewById(R.id.from_inbox);
            viewHolder.txtSubject = (TextView) convertView.findViewById(R.id.subject_inbox);
            viewHolder.txtDate = (TextView) convertView.findViewById(R.id.date_inbox);
