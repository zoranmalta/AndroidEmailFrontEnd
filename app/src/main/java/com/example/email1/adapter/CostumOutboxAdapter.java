...
//        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CostumOutboxAdapter.ViewHolder viewHolder; // view lookup cache stored in tag

        final View result;

        if (convertView == null) {

            viewHolder = new CostumOutboxAdapter.ViewHolder();
            ...
            viewHolder = (CostumOutboxAdapter.ViewHolder) convertView.getTag();
            result=convertView;
        }
