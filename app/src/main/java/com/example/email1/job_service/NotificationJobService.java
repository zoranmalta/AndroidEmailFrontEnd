package com.example.email1.job_service;
...
import com.example.email1.EmailsActivity;
import com.example.email1.MessageActivity;
        ...
        call.enqueue(new Callback<List<Message>>() {
            ...
            public void onResponse(Call<List<Message>> call, Response<List<Message>> response) {
                if(response.isSuccessful()) {
                    ...
                    Log.d("filter", resObject.toString());
                    messages = resObject;
